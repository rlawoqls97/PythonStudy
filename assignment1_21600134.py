...
# 4.
m_walk = int(input("오늘 당신이 걸은 걸음의 수를 정수로 입력해주세요: "))
if m_walk < 0:
    print("걸음 수는 음수일 수 없습니다.")
avg = m_walk // int(24.0 - float(sleep_hour))
# 5.
...
# 8.
if float(sleep_hour) <= 6 and m_walk > 8000:
...
# 13.
if float(sleep_hour) >= 9 and m_walk < 8000:
